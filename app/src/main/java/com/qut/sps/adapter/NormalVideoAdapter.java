...
public class NormalVideoAdapter extends RecyclerView.Adapter<NormalVideoAdapter.ViewHolder> {
    ...
    public NormalVideoAdapter(List<Map<String,String>> videoList){
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(getContext()).inflate(R.layout.normal_video_item,parent,false);

...
public class Sms {
	...
	static final String accessKeyId = "LTAIU13XUaesgjny";
	static final String accessKeySecret = "Tvj92udzRqD3pfzw0pmPrvAsuPzoik";
	...
	public static SendSmsResponse sendSms(String phoneNumber, String code) throws ClientException {
		...
		// 必填:短信签名-可在短信控制台中找到
		request.setSignName("舞吧");
		// 必填:短信模板-可在短信控制台中找到
		request.setTemplateCode("SMS_86575114");
